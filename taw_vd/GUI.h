...
class RscControlsGroupNoScrollbars1 : RscControlsGroup1 {
...
class RscButtonMenu1:RscShortcutButton1 {
	idc = -1;
	type = 16;
	style = "0x02 + 0xC0";
	default = 0;
...
class TAW_VDMenu {
	...
	class controlsBackground {
		class TitleBackground : RscText1 {
		...
		class ButtonClose : RscButtonMenu1 {
			idc = -1;
			text = "Close";
	...
	class controls {
		...
		//Sliders
		class VD_onFoot_slider : RscXSliderH1 {
			idc = INFANTRY_SLIDER;
			text = "";
		...
		class ObjectSyncCheckbox : RscCheckbox1
		{
			idc = 2931;
			x = .32; y = .6;
		...
		class Manager:RscControlsGroup1 {
			idc = MANAGER_GROUP;
			
			x = -0.21; y = .2;
			w = .5; h = 3;
			class Controls {
				class SaveLoadGroup:RscControlsGroupNoScrollbars1 {
					idc = SAVELOAD_GROUP;
					...
					class Controls {
						class MyTitleBackground:RscText1 {
							colorBackground[] = { "(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", "(profilenamespace getvariable ['GUI_BCG_RGB_A',0.7])" };
							idc = -1;
							x = 0;
							y = 0;
						...
						class SaveButton:RscButtonMenu1 {
							text = "Save";
						...
						class HideButton:RscButtonMenu1 {
							text = "Hide";
